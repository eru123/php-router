...
use eru123\router\Fs\File;
use eru123\router\Http\Fetch;
...
class Router
{
     ...
     * @param callable|null|string|array $callback
     ...
     * @return Router|callable|null
     */
    public function error(callable|string|array|null $callback = null): static|callable|null|string
    {
     ...
     * @return Router|callable|null
     */
    public function response(callable|string|array|null $callback = null): static|callable|null|string
    {
        if (is_string($callback) || is_array($callback)) {
            $callback = $this->make_callable($callback);
        }
